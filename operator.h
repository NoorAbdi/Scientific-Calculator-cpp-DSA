...
// Tokenizes the input equation and stores the tokens in equationQueue
void Calculator::toString() {
...
// Processes exponentiation operations (^) in the equation
...
// Processes multiplication (*) and division (/) operations in the equation
...
// Processes logarithmic (log and ln) operations in the equation
...
// Processes trigonometric (sin, cos, tan) operations in the equation
